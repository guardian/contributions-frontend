...
object ProfileLinks {
  ...
  val editProfile =  Config.idWebAppUrl / "public/edit"

  val editProfileMembership =  Config.idWebAppUrl / "membership/edit"

  val emailPreferences =  Config.idWebAppUrl / "email-prefs"
