...
val identityCookie =  "com.gu.identity" %% "identity-cookie" % "3.100"
val identityModel =  "com.gu.identity" %% "identity-model" % "3.100"
...
val acquisitionEventProducer = "com.gu" %% "acquisition-event-producer" % "2.0.3"
