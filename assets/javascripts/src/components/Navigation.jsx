...
export default class Navigation extends React.Component {
    render() {
        ...
        return <div className="contribute-navigation">
          ...
          {showPay && <button className="contribute-navigation__button contribute-navigation__pay action action--button action--pay">Pay {this.props.symbol}{this.props.amount}</button>}
        </div>;
    }
}
