...
export default class Navigation extends React.Component {
    ...
    render() {
        ...
        {showStripePaymentOption &&  <Forward data-link-name="contribute-with-stripe" className="contribute-navigation__button action action--button contribute-navigation__next action--next contribute_card__button" onClick={this.props.clearPaymentFlags}>{"Contribute with debit/credit card"}</Forward>}
        {isFirstPage && <Forward data-link-name="contribute-with-paypal" className="contribute-navigation__button action action--button  paypal__button" onClick={this.props.payWithPaypal}>Contribute with</Forward>}
