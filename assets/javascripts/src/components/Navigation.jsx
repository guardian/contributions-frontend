...
export default class Navigation extends React.Component {
    ...
    render() {
        ...
        const isPaymentPage = this.props.page == PAGES.PAYMENT;
//todo if I make the button say "contribute with debit/credit card" the text is too long and the button goes into 2 lines
        ...
        {isPaymentPage && <Back className="action--secondary contribute-navigation__back show-mobile" onClick={this.props.jumpToFirstPage}>Back</Back>}
